...
interface SensorData {
  ...
  aiFeatures?: {
    ...
    CO2_avg: number | null;
    CO2_std: number | null;
    Vibration_amp: number | null;
    Vibration_freq: number | null;
    Hour: number;
  };
...
const HealthAlerts: React.FC = () => {
  ...
  const getHealthProfile = (
    ...
    if (aqi > 300 || co2 > 5000) {
      return {
        ...
        activityAdvice:
          '❌ NO OUTDOOR ACTIVITIES - Emergency evacuation recommended',
      ...
      return {
        ...
        activityAdvice:
          '🚫 AVOID ALL OUTDOOR ACTIVITIES - Indoor air filtration recommended',
      ...
      return {
        ...
        activityAdvice:
          '⛔ INDOOR ACTIVITIES ONLY - No outdoor exercise recommended',
      ...
      return {
        ...
        activityAdvice:
          '⚡ LIMITED OUTDOOR ACTIVITIES - Short exposure acceptable with precautions',
      ...
      return {
        ...
        activityAdvice:
          '✅ ALL ACTIVITIES RECOMMENDED - Perfect conditions for exercise and outdoor recreation',
  ...
  const locationHealthData: Record<string, LocationHealthData> = {
    'vizianagaram-live': {
      ...
      ...getHealthProfile(
        liveData && liveData.mq135.raw != null
          ? convertRawToAQI(liveData.mq135.raw)
          : 75,
        liveData && liveData.co2 ? liveData.co2.ppm : 420,
        true
      ),
    ...
    'jonnada-live': {
      ...
      isLive: true,
      bestTimes:
        'Local area conditions updated based on main station with environmental modeling',
      ...getHealthProfile(
        liveData && liveData.mq135.raw != null
          ? Math.max(
              20,
    ...
    'iit-campus': {
      ...
      activityAdvice:
        'Safe for jogging, sports, outdoor study sessions, and all recreational activities',
      pollutantInfo:
        'Clean environment - Low pollution from all sources. Minimal vehicle emissions due to restricted campus access.',
      bestTimes:
        'All day suitable - particularly pleasant during morning hours (6-10 AM)',
      icon: TreePine,
      gradient: 'from-green-400 to-green-500',
      riskLevel: 'safe',
      updateInterval: 30 * 1000,
    ...
    'main-road': {
      ...
      co2: 445,
      description:
        'High traffic corridor with elevated vehicle emissions',
      recommendations: [
      ...
      activityAdvice:
        'Avoid exercise during rush hours - indoor activities preferred during peak traffic times',
      pollutantInfo:
        'Elevated vehicle emissions - VOC and particulate matter levels moderate to high during traffic peaks.',
      bestTimes:
        'Best air quality: Early morning (5-7 AM) and late evening (9-11 PM)',
      icon: Car,
    ...
    'lake-area': {
      ...
      activityAdvice:
        'Excellent for all activities - jogging, cycling, yoga, and recreational sports highly recommended',
      pollutantInfo:
        'Pristine environment - Natural air filtration from vegetation. Lowest pollution levels in the area.',
      bestTimes:
        'Exceptional air quality throughout the day - sunrise and sunset particularly beautiful',
      icon: TreePine,
    ...
    'commercial': {
      ...
      activityAdvice:
        'Indoor activities preferred - short outdoor exposure acceptable with precautions',
      pollutantInfo:
        'Mixed urban pollutants - Elevated VOC from businesses, vehicle emissions, and construction activities.',
      bestTimes:
        'Better air quality: Early morning (6-8 AM) and after business hours (8 PM onwards)',
      icon: Building,
      gradient: 'from-red-400 to-orange-500',
      riskLevel: 'high',
      updateInterval: 30 * 1000,
    ...
    'residential': {
      ...
      co2: 405,
      description:
        'Mixed residential area with moderate pollution levels',
      recommendations: [
      ...
      activityAdvice:
        'Morning outdoor activities recommended - avoid peak commuter hours for exercise',
      pollutantInfo:
        'Typical urban levels - Morning air quality best due to reduced traffic and settled particulates.',
      bestTimes:
        'Optimal times: Early morning (6-9 AM) and evening (7-9 PM)',
      icon: Home,
      gradient: 'from-orange-400 to-yellow-500',
      riskLevel: 'moderate',
      updateInterval: 30 * 1000,
          ...
          <div className="flex items-center mb-4">
            ...
            <div className="ml-4">
              <h3 className="text-xl font-semibold text-gray-800">
                AtmosTrack Global Pollution Source Classifier
              </h3>
              <p className="text-sm text-gray-500">
                AI model using VOC, CO₂, vibration and time of day to classify
                the dominant pollution source.
              </p>
            </div>
          </div>

          {liveData && liveData.sourceClassification ? (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
              ...
              <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min(
                      100,
                      liveData.sourceClassification.confidence
                    )}%`,
                  }}
                />
              </div>
              ...
              <div className="text-xs text-gray-500 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <span>
                  ...
                  {liveData.sourceClassification.modelAccuracy}%
                </span>
                {liveData.aiFeatures && (
                  <span>
                    Features: VOC_avg{' '}
                    {liveData.aiFeatures.VOC_avg != null
                      ? liveData.aiFeatures.VOC_avg.toFixed(0)
                      : '–'}
                    , CO₂_avg{' '}
                    {liveData.aiFeatures.CO2_avg != null
                      ? liveData.aiFeatures.CO2_avg.toFixed(0)
                      : '–'}
                    , vibration-based activity
                  </span>
                )}
              </div>
            </div>
            ...
            <div className="text-sm text-gray-500">
              Waiting for enough live readings to build AI features and classify
            ...
            <div className="flex-1">
              ...
              >
                {currentLocation.riskLevel === 'safe'
                  ...
                  : currentLocation.riskLevel === 'high'
                  ? 'Air Quality Caution Advisory'
                  : currentLocation.riskLevel === 'very_unhealthy'
                  ? '⚠️ VERY UNHEALTHY AIR QUALITY'
